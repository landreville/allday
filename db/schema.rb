...
ActiveRecord::Schema[8.0].define(version: 20_260_301_191_929) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.index %w[transcript_id sequence], name: "index_messages_on_transcript_id_and_sequence", unique: true
